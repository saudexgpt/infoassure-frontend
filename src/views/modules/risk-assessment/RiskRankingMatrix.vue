      ...
      <table class="table table-bordered">
        <tbody>
          ...
          <tr>
            ...
            <td> All risk values &gt; 2 but &lt;= 5 (Line Manager action/decision required)</td>
          </tr>
          <tr>
            <td style="color: #000000; background: green">
              Low
            ...
            <td>All risk values &gt;=1 but &lt; 3 (no action required however recommended for improvement to Line Manager)</td>
          </tr>
        </tbody>
      </table>
