    ...
    <el-row :gutter="10" class="padded">
      ...
      <el-col :xs="24" :sm="12" :md="12">
        <b-row v-loading="loader">
          ...
          <b-col md="12">
            <b-form-group label="Select Standard" label-for="level">
              <el-select
          ...
          <b-col md="12">
            <b-form-group label="Select Clause" label-for="class">
...
export default {
  ...
  methods: {
    ...
    addBulkProductToStock() {
      const { form } = app
      if (form.clause_id === '') {
        this.$message({ message: 'Please select a clause from a standard', type: 'danger' })
      } else {
