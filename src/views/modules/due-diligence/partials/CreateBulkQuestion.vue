      ...
      <el-col :xs="24" :sm="12" :md="12">
        <div style="background: #f0f0f0; color: #000000; padding: 10px">
          ...
          <ol>
            ...
            >
            <li
              >Delete the three sample entries given to guide you and start from row number two (2)
              in the file.</li
            >
            <li
      ...
      import('@/vendor/Export2Excel').then((excel) => {
        ...
        const data = [
          [
            ...
            'Upload latest audit report if applicable',
            'both',
            'yes'
          ],
          [
            'Security & Data Protection Risk',
            'Do you process or store sensitive customer or company data?',
            '',
            'yes-no',
            'no'
          ],
          [
            'Security & Data Protection Risk',
            'Do you have a formal cybersecurity policy?',
            'Upload cybersecurity policy if applicable',
            'yes-no',
            'yes'
          ]
