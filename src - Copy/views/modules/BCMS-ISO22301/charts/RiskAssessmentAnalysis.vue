...
export default {
      ...
      chart_report: {
        chart: {
          ...
          events: {
            ...
            drillup() {
              this.setTitle({ text: 'Risk Analysis by Business Unit' }, { text: 'Drilldown to view details for each Business Process' })
            },
          },
        },
        title: {
  ...
  methods: {
    ...
    fetchReportSummary() {
      ...
      app.load = true
      app.showChart = false
      const param = { client_id: app.selectedClient.id, module: 'bcms' }
