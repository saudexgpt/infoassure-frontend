      ...
      >
        <div style="background: #f0f0f0; color:#000000; padding: 10px;">
          ...
          <ol>
            ...
            <li>For the ANSWER_TYPE field, use the values<br>*<code>open_ended</code><br>*<code>yes-no</code><br>*<code>both</code><br> as spelt where applicable</li>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        ...
        const tHeader = ['QUESTION', 'ANSWER_TYPE']
        // const filterVal = []
    ...
    addBulkProductToStock() {
      ...
      const { form } = app
      if (form.clause_id === '') {
        app.$message({ message: 'Please select a clause from a standard', type: 'danger' })
      } else {
        form.bulk_data = app.tableData
        app.loader = true
        const uploadBulkStudents = new Resource('questions/upload-bulk')
