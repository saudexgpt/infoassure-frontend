    ...
    return {
      chart_report: {
        chart: {
          ...
          events: {
            drilldown(e) {
              this.setTitle({ text: 'Risk Severity by Asset' }, { text: `Data showing risk analysis for ${e.point.name}` })
            },
            drillup() {
              this.setTitle({ text: 'Risk Severity by Asset Type' }, { text: 'Drilldown to view details for each asset' })
            },
          },
        },
        title: {
