<template>
  <el-card>
    ...
    <el-dialog v-model="showModal" hide-footer centered size="lg" title="Create Project Plan">
      <add-general-project-plan v-if="showModal" :module-id="moduleId" @saved="fetchProjectPlan" />
    </el-dialog>
    <el-dialog v-model="showEditModal" hide-footer centered size="lg" title="Edit Project Plan">
