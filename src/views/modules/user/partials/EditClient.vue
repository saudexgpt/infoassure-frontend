...
export default {
  ...
  methods: {
    setFormProperties(selectedClient) {
      const app = this
      app.form.id = selectedClient.id
      app.form.organization_name = selectedClient.name
      app.form.contact_email = selectedClient.contact_email
      app.form.contact_phone = selectedClient.contact_phone
      app.form.contact_address = selectedClient.contact_address

      if (selectedClient.users.length > 0) {
        app.form.admin_id = selectedClient.users[0].id
        app.form.admin_name = selectedClient.users[0].name
        app.form.admin_email = selectedClient.users[0].email
        app.form.admin_phone = selectedClient.users[0].phone
        app.form.designation = selectedClient.users[0].designation
      }
    },
    formSubmitted() {
      const app = this
