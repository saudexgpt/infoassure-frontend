  ...
  <div>
    ...
    <el-row v-else :gutter="10">
      ...
      <el-col :md="12">
        ...
        <input placeholder="Click to select file" type="file" @change="onImageChange" />
      </el-col>
      <el-col :md="24">
...
export default {
  ...
  methods: {
    ...
    formSubmitted() {
      ...
      formData.append('incident_type_id', this.form.incident_type_id)
      formData.append('severity', this.form.severity)
      formData.append('affected_assets[]', this.form.affected_assets)
      formData.append('location', this.form.location)
      formData.append('occurred_at', this.form.occurred_at)
