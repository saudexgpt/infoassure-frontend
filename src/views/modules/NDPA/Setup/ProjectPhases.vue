<template>
  <el-card>
    ...
    <el-dialog v-model="showModal" hide-footer centered title="Enter Phase Title">
      <el-row v-loading="loading" :gutter="20">
        ...
        <el-col :xs="24">
          <small
            >You can enter multiple phase titles, just separate them by hitting the
            <code>ENTER</code> button key</small
          >
          <br />
          <!-- <el-input
            v-model="form.titles"
          ...
          <el-select
            ...
            style="width: 100%"
          >
            <el-option v-for="item in form.titles" :key="item" :label="item" :value="item" />
          </el-select>
          <hr />
        </el-col>
        <el-col :xs="24">
...
export default {
  ...
  methods: {
    ...
    fetchProjectPhases() {
      ...
      fetchProjectsResource.list({ module_id: this.moduleId }).then((response) => {
