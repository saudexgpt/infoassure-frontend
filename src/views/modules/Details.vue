...
<template>
  <el-container class="no-margin" style="height: 750px; border: 1px solid #eee">
    <el-aside v-if="showMenu" width="250px">
      <label>Modules</label>
      <div>
        <el-menu :router="true">
          <el-submenu
          ...
          >
            <template v-slot:title>
              <h4
                ><strong>{{ project.available_module.name }}</strong></h4
              >
            </template>

            <el-menu-item :index="`${project.available_module.slug}-dashboard`">
              <p>Overview</p>
            </el-menu-item>
            <el-menu-item :index="`manage-${project.available_module.slug}`">
              <p>Activities</p>
            </el-menu-item>
            <el-menu-item :index="`${project.available_module.slug}-report`">
              <p>Reports</p>
            </el-menu-item>
          </el-submenu>
        </el-menu>
