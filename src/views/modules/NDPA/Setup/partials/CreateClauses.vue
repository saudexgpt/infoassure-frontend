  ...
  <div>
    ...
    >
      <template #default="{ hide }">
        ...
        >
          <h5 class="mel-0"> Create Clauses </h5>
          <div>
        ...
        <div class="justify-content-between align-items-center px-2 py-1">
          <el-row v-loading="loading">
            ...
            <el-col cols="12">
              <el-form-group label="Requirement name" label-for="v-level_group">
                ...
                <el-form-input v-model="form.names" placeholder="example: PART V" />
              </el-form-group>
            </el-col>
            <el-col cols="12">
              <el-form-group label="Description" label-for="v-level_group">
                <el-form-input
...
export default {
  ...
  methods: {
    submit() {
      this.loading = true
      const saveCurriculumSetupResource = new Resource('ndpa/clauses/save')
