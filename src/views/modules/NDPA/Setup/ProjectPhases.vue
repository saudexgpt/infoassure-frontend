  ...
  <el-card>
    ...
    >
      ...
      >
        ...
        <el-col :xs="24">
          <small>You can enter multiple phase titles, just separate them by hitting the <code>ENTER</code> button key</small>
          <br>
          <!-- <el-input
            v-model="form.titles"
